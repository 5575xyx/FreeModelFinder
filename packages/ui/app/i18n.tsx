...
const zh: Dict = {
  ...
  'settings.autoRoute.modality.desc': '当 model 为 auto 时，根据请求内容自动选择合适的模型。检测到图片走图片模型，检测到视频关键词走视频模型，其余走默认文本模型。',
  ...
  'settings.autoRoute.textTiers.desc': '纯文本请求根据复杂度自动选择模型。简单问题走轻量模型（快），复杂任务走强模型（准）。',
