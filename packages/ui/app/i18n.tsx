...
const zh: Dict = {
  ...
  'settings.sources.pastePlaceholder': '粘贴 API Key（多个用逗号分隔）',
  'settings.sources.pasteExisting': '••••••••••（覆盖以更新，可逗号分隔多个）',
  ...
  'settings.custom.apiKeyExisting': '••••••••••（留空则保持不变，多个用逗号分隔）',
  'settings.custom.apiKeyPlaceholder': '粘贴 API Key（多个用逗号分隔；本地无鉴权可留空）',
...
const en: Dict = {
  ...
  'settings.sources.pastePlaceholder': 'Paste API key(s), comma-separated',
  'settings.sources.pasteExisting': '••••••••••  (override to update, comma-separate for multiple)',
  ...
  'settings.custom.baseUrl': 'Base URL',
  'settings.custom.apiKey': 'API Key',
  'settings.custom.apiKeyExisting':
    '••••••••••  (leave empty to keep unchanged; comma-separate multiple)',
  'settings.custom.apiKeyPlaceholder':
    'Paste API key(s), comma-separated (leave empty for local unauthenticated)',
