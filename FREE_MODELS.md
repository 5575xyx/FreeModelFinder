...
> 最近目录审计：**2026-08-28（Asia/Shanghai）** · **58** 个免费模型入口 · **9/10** 个 Provider 正常。

[返回项目 README](README.md) · [查看本次目录审计报告](reports/provider-free-model-audit-2026-08-28.md)
...
| NVIDIA NIM    | 🟢 正常 |         15 | 免费开发端点          | 只保留审核过的 build.nvidia.com 免费开发端点                                        |
