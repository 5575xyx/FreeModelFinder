...
> 最近目录审计：**2026-09-12（Asia/Shanghai）** · **59** 个免费模型入口 · **9/10** 个 Provider 正常。

[返回项目 README](README.md) · [查看本次目录审计报告](reports/provider-free-model-audit-2026-09-12.md)
...
| Hugging Face  | 🟢 正常 |          5 | 实时零价端点          | 实时端点明确报告 `is_free`，或输入输出价格均为 0                                    |
