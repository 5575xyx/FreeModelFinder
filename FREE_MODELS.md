...
> 最近目录审计：**2026-09-01（Asia/Shanghai）** · **59** 个免费模型入口 · **9/10** 个 Provider 正常。

[返回项目 README](README.md) · [查看本次目录审计报告](reports/provider-free-model-audit-2026-09-01.md)
...
与 2026-08-31 相比，在成功比较的 9 个 Provider 中：**新增 2 个，移除 0 个**。
...
| NVIDIA NIM    | 🟢 正常 |         14 | 免费开发端点          | 只保留审核过的 build.nvidia.com 免费开发端点                                        |
...
| `openrouter:inclusionai/ling-3.0-flash-fin:free`                | Ling 3.0 Flash Fin (free)               |     262.1K |
| `openrouter:liquid/lfm-2.5-2.6b:free`                           | LiquidAI: LFM2.5-2.6B (free)            |      65.5K |
| `openrouter:minimax/minimax-m2.7:free`                          | MiniMax: MiniMax M2.7 (free)            |     196.6K |
| `openrouter:minimax/minimax-m3:free`                            | MiniMax: MiniMax M3 (free)              |         1M |
